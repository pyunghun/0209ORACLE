...
public class MainMenu {
	...
	public void displayMenu() {
		...
		do {
			...
			System.out.println("6. 입사일 순 오름차순 정렬 조회");
			System.out.println("7. 입사일 순 내림차순 정렬 조회");
			System.out.println("8. 급여 상위 5명 조회");
			System.out.println("9. 급여 상위 6 ~ 10위  조회");
			...
			switch(no) {
			case 1 : empDAO.findOneEmpByEmpId(inputEmpId()); 
				break;
			case 2 : 
				break;
			case 3 : 
